                            ...
                            <div class="bg-white rounded-lg shadow p-6 mb-8">
                                ...
                                <form class="space-y-4" method="POST"
                                    ...
                                    <div class="flex justify-end">
                                        <button type="submit"
                                            class="bg-blue-600 dark:bg-blue-400 text-white px-4 py-2 text-sm font-medium hover:bg-blue-500 rounded-md">
                                            ...
                                            @foreach ($depenses as $depense)
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"> <span
                                                            class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">{{ $depense->categorie->title }}</span>
                                                    </td>
                                                    <td
